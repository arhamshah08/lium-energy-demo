...
const GATES = [
  ...
  { id: 'G5', label: 'Credit Enhancement Gate',  category: 'CAT5', status: 'PASS',   metric: 'OC 25% · Cash reserve $2M · AAA tranche',       icon: 'verified_user' },
  ...
  { id: 'G7', label: 'Regulatory Gate',          category: 'CAT7', status: 'PASS',   metric: 'All permits current · FERC market-based rate authority', icon: 'account_balance' },
]
      ...
      <div className="bg-secondary-container/20 border border-secondary/20 rounded-xl p-5 flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-caption text-on-surface-variant mt-0.5">
            6 of 7 gates fully passed. Gate G3 flagged for review (DSCR dips in Y3/Y5/Y10 mitigated by $2M cash reserve).
